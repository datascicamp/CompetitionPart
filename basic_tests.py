...
if __name__ == '__main__':
    ...
    record = {
        ...
        "comp_host": "[{'comp_host_name': '天池', 'comp_host_url': 'https://tianchi.aliyun.com/home/'}]",
        "prize_currency": "USD",
        "prize_amount": "10000",
        ...
        "timezone": "UTC",
        "comp_scenario": "['CV', 'NPL']",
        "data_feature": "['一维数组']",
        "contributor_id": "233"
    }

    result = requests.post("http://service.datascicamp.com:30081/api/competition",
                           data=record)
