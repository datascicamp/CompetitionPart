...
def usage():
    usages = [
        ...
        {'api_format': '/api/competition/competition-record-hash/<string:comp_record_hash>', 'method': 'PUT',
         'description': 'Modify an existed competition info by hash'},
        {'api_format': '/api/competition/<string:rid>', 'method': 'PUT',
         'description': 'Modify an existed competition info'},
        {'api_format': '/api/competition/competition-record-hash/<string:comp_record_hash>', 'method': 'DELETE',
         'description': 'Delete an existed competition info by hash'},
